...
class Model(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        resnet_11 = ResnetBlock(512,3) # filters, kernel_size
        res11= resnet_11.call(res10)
        resnet_12 = ResnetBlock(512,3) # filters, kernel_size
        res12 = resnet_12.call(res11)
        dropped_out_res12 = self.drop_layer(res12)
        # print('before pool shape ', dropped_out_res12.shape)
        ...
        dropped_pool = tf.reshape(dropped_pool,(-1,512))
        # print('pool shape ', dropped_pool.shape)
